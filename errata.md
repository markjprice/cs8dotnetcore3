...
In Step 7, a new feature introduced in Visual Studio Code 1.41 in November 2019 might confuse you: [compact folders](https://github.com/microsoft/vscode-docs/blob/vnext/release-notes/v1_41.md#compact-folders-in-explorer). The compact folders feature means that nested folders like /Areas/MyFeature/Pages/ are shown in a compact form if they do not contain files.
